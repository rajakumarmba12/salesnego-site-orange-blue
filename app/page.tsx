...
const experience = [
  ...
  ['Engineering & Industrial Technology', 'Commercial experience involving engineering software, digital products and technical solution selling.'],
  ...
  return (
    <main>
      <header className="site-header">
        <a className="wordmark" href="#home" aria-label="SalesNego home">Sales<span>Nego</span></a>
        ...
        <a className="button button-small header-cta" href="#contact">Discuss Your Growth Priorities</a>
      </header>
      ...
      <section className="hero" id="home">
        ...
        <div className="section-shell hero-grid">
          <div className="hero-copy">
            ...
            <div className="button-row"><a className="button" href="#contact">Discuss Your Growth Priorities</a><a className="text-link light-link" href="#system">Explore How We Execute <span>→</span></a></div>
          </div>
      ...
      <section className="proof-strip" aria-label="Client proof"><div className="section-shell proof-inner"><div><p className="eyebrow">SELECTED COMPANIES</p><p>Commercial experience across SaaS, enterprise technology, digital products and technology services.</p></div><div className="logo-placeholders" aria-label="Approved client logo placeholders"><span /><span /><span /><span /><span /></div></div></section>
      ...
      <section className="section services-section">
        ...
        <div className="section-shell image-panel"><img src={marketImage} width="1484" height="1060" alt="B2B SaaS market intelligence and target account prioritization framework" loading="lazy" decoding="async" /></div>
      </section>
      ...
      <section className="section dark-section" id="ai-revops">
        ...
        <div className="section-shell image-panel image-panel-dark"><img src={revOpsImage} width="1484" height="1060" alt="AI-assisted Revenue Operations workflow for B2B SaaS sales" loading="lazy" decoding="async" /></div>
      </section>
      ...
      <section className="section cta-section" id="contact"><div className="section-shell cta-grid"><div><p className="eyebrow light">START WITH THE COMMERCIAL PROBLEM</p><h2>Where Should Your Next Revenue Opportunity Come From?</h2><p>Tell us what you are selling, where you are trying to grow and what is currently getting in the way. We will determine whether SalesNego is the right commercial partner for the problem.</p><p className="cta-note">No generic sales pitch. Start with the commercial situation.</p></div><form className="contact-form"><label>Name<input name="name" type="text" autoComplete="name" required /></label><label>Business Email<input name="email" type="email" autoComplete="email" required /></label><label>Company Website<input name="website" type="url" inputMode="url" /></label><label>What are you selling?<input name="offering" type="text" required /></label><label>Target market<input name="market" type="text" /></label><label>What are you trying to achieve?<textarea name="message" rows={4} required /></label><button className="button" type="submit">Discuss Your Growth Priorities</button></form></div></section>

      <footer className="site-footer"><div className="section-shell footer-grid"><div><a className="wordmark footer-wordmark" href="#home">Sales<span>Nego</span></a><p>Commercial execution for B2B SaaS, AI and technology companies.</p></div><div><h3>Capabilities</h3><a href="#what-we-do">GTM Strategy &amp; Market Intelligence</a><a href="#ai-revops">Revenue Operations &amp; AI-Accelerated Sales</a><a href="#system">End-to-End Commercial Execution</a></div><div><h3>Markets</h3><p>North America<br />UAE<br />UK<br />India</p></div><div><h3>Contact</h3><a href="mailto:sales@salesnego.com">sales@salesnego.com</a></div></div><div className="section-shell footer-bottom"><span>© 2026 SalesNego. All rights reserved.</span><span><a href="#">Privacy Policy</a> <a href="#">Terms</a></span></div></footer>
    </main>
  );
}
